      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-3xl md:text-4xl font-medium leading-tight text-white/90">
            With 9+ years of experience in full-stack development and solution architecture, 
            I've led engineering teams at Publicis Sapient through complex digital transformations, 
            migrated legacy monoliths to cloud-native microservices, and built fintech platforms used by millions.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
            <p className="text-white/60 leading-relaxed">
              My expertise spans Fintech and Enterprise SaaS, where I focus on 
